...
column window without breaking any words. Use a generator that yields the next lines 
of text, each containing as many words as possible
'''
...
'''
example of the implementation as below:
